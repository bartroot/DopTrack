...
%         // input 2-line element set file
    ...
    %infilename = 'TLE_DelfiC3.txt';
    %infilename = 'TLE_Delfin3Xt_23.txt';
    %infilename = 'TLE_Delfin3Xt_24.txt';
    %infilename = 'TLE_Delfin3Xt_25.txt';
    infilename = '../../../../TLE/getTLE/TLE.txt';
    
    filename = 'TLE_5days_16_05_2015';
            ...
            while ((tsince < stopmfe) && (satrec.error == 0))
                ...
                if (satrec.error == 0)
                    if ((typerun ~= 'v') && (typerun ~= 'c'))
                        ...
                        XYZ(i,:) = [tsince ro(1) ro(2) ro(3) vo(1) vo(2) vo(3) year mon day hr minute sec];
                           i=i+1;
                    else
                        jd = satrec.jdsatepoch + tsince/1440.0;
                        [year,mon,day,hr,minute,sec] = invjday ( jd );
...
dlmwrite([filename '.xyz'],XYZ,'delimiter','\t','precision','%15.8e');