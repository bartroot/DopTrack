...
start_rtl_command="uhd_rx_cfile -f 45.07M --samp-rate={samp_rate} --wire-format=sc16 --output-shorts --gain=20 /dev/stdout | nc -vvl 127.0.0.1 8888".format(rf_gain=rf_gain, center_freq=center_freq, samp_rate=samp_rate, ppm=ppm)
