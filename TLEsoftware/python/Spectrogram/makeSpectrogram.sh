...
ls /media/data/ | grep Delfi | cut -c 1-32 | sort > test1
ls /home/doptrack/www/archive_all/ | grep Delfi | cut -c 1-32 | sort > test2
...
do
	...
	line_in=$(echo $dir$line".32fc")
        ...
        python spectrogram.py -i $line_in -o $line_out
